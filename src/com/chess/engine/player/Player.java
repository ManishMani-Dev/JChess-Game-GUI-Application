...
public abstract class Player {
    ...
    Player(final Board board,
        ...
        this.board = board;
        this.playerKing = establishKing(); // TODO little check !! with playerKing -->cleared
    ...
    public MoveTransition makeMove(final Move move){
        ...
        final Board transitionBoard = move.execute(); //after execute the current player white changes to black !!
        //// so we are check the white king by current players opponent king position if it will be attacked by black after execute
