...
public abstract class Move {
    ...
    public Board execute() {
        ...
        builder.setMoveMarker(this.board.currentPlayer().getOpponent().getAlliance());
    ...
    public static class AttackMove extends Move{
        ...
        public boolean equals(final Object other){
            ...
            return super.equals(otherAttackMove) && getAttackedPiece().equals(other);
        }
        @Override
        public boolean isAttack(){
            return true;
    ...
    public static class PawnPromotion extends Move{
        ...
        public Board execute(){
            ...
            builder.setMoveMarker(pawnMovedBoard.currentPlayer().getAlliance());
            return builder.build();
        }
        @Override
        public Piece getAttackedPiece(){
    ...
    static abstract class CastleMove extends Move{
        ...
        public Board execute(){
            ...
            builder.setPiece(new Rook(castleRook.getPieceAlliance(),this.castleRookDestination));
