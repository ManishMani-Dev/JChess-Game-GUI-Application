...
public abstract class Tile {
    ...
    private  Tile(final int tileCoordiante){


        this.tileCoordiante = tileCoordiante;
    }
    public abstract boolean isTileOccupied(); //this is called abstract because it is not going to be declared here but to be declared in sub-class
    public abstract Piece getPiece();
    public int getTileCoordinate(){
        return this.tileCoordiante;
    }
